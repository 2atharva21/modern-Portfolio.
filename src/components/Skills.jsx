                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            num="1"
                            title="Ui/Ux Design"
                            desc="These skills encompass the essential areas of UI/UX design and demonstrate your ability to create intuitive, user-centered interfaces that prioritize usability and aesthetics."
                            data={[
                                "User Research",
                        ...
                        <Service
                            ...
                            desc="These skills encompass the core competencies required for graphic designers, allowing them to create visually compelling designs across various mediums."
                            data={[
                        ...
                        <Service
                            ...
                            desc="These skills encompass the core competencies required for frontend development, allowing you to create engaging and user-friendly web experiences."
                            data={[
                                "HTML",
                                "CSS",
                                "JavaScript",
                        ...
                        <Service
                            ...
                            desc="WordPress Development involves building websites and web applications using the WordPress content management system (CMS). "
                            data={[
                                "WordPress CMS:",
                                "Theme Development",
                                "Plugin Development:",
